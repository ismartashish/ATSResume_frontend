    ...
    <div className="result-wrapper">
      ...
      <div className="resume-preview">
        ...
        <div className="diagnostic-box info">
          ...
          <p>
            Your resume has the required sections, but ATS systems
            prioritize job-specific keywords and natural phrasing.
          </p>
        </div>
        ...
        {missingSkills.length > 0 && (
          <div className="diagnostic-box bad">
            <h4>Why Your Score Is Low ❌</h4>
            <ul>
              <li>Missing job-specific technical keywords</li>
              <li>Skills not reflected inside experience/projects</li>
              <li>ATS keyword match is weak</li>
            </ul>
          </div>
        )}
        ...
        <div className="diagnostic-box quick">
          <h4>How to Fix This in 15 Minutes ⚡</h4>
          <ol>
            <li>Add missing skills inside <strong>Projects</strong></li>
            <li>Mention tools in each experience</li>
      ...
      <div className="ats-panel">
        ...
        <ul className="ats-list">
          <li className="ok">Contact Information</li>
          <li className="ok">Professional Summary</li>
          <li className={missingSkills.length ? "warn" : "ok"}>Work History</li>
          <li className="ok">Skills</li>
          <li className={missingSkills.length ? "warn" : "ok"}>Education</li>
        </ul>
